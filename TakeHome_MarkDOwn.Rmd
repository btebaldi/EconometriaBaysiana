...
library(pracma)  # Used for Time Evaluation
...
for (k in 1:2) {
  ...
  {
    dt_time[k, "ess"] = round(M/(1+2*sum(acf(draws.gibbs[,"sigma"],lag.max=1000,plot=FALSE)$acf[2:1001])))
  }
